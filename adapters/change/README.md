...
The reference update adapter installs a pinned third-party application update. A second adapter breaks the workflow on purpose so a FAIL run can be shown without faking anything.
