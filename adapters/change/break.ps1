...
try {
    $splat = @{ Adapter = 'break'; Operation = $Operation; ChangeId = $ChangeId; Target = $Target; Parameters = (ConvertFrom-Json -InputObject $Parameters); UseCurrentCredentials = $UseCurrentCredentials; Local = $Local; TargetTransport = $TargetTransport; TargetPort = $TargetPort }
