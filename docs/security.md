...
All operators/runners must use one canonical target alias and shared state location. Locks protect cooperating callers, not arbitrary admins. Cancellation does not prove a target idle. Stop continuous testing in LE before restoration or another mutation.
